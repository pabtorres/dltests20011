...
import numpy as np
from persist_results_temp import *
...
resnext101_3dx8d = torchvision.models.resnext101_32x8d()

# Wrapper del modelo
class ClassifierModule(nn.Module):
    def __init__(self):
        super(ClassifierModule,self).__init__()
        self.net = resnext101_3dx8d
...
def run_it():
  ...
  net = ClassifierModule() # tu modelo de CNN (para clasificar en 1000 clases)
  ...
  persist_tuple_prefix((train_loss, acc), "resnext101_3dx8d_classic_")

  print("Almacenando punto de control")
  PATH = "./resnext101_3dx8d__checkpoint_epoch_5_classic"
  torch.save({
              'epoch': 5,
  ...
  persist_tuple_prefix((train_loss, acc), "resnext101_3dx8d_reduced_")

  print("Almacenando punto de control")
  PATH = "./resnext101_3dx8d__checkpoint_epoch_6_reduction"
  torch.save({
              'epoch': 6,
              'model_state_dict': net.state_dict(),
              'optimizer_state_dict': optimizer.state_dict(),
