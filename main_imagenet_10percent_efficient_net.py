...
efficientnet = EfficientNet.from_name('efficientnet-l2')
...
def run_it():
  ...
  persist_tuple_prefix((train_loss, acc), "efficientnet_l2_classic_")

  print("Almacenando punto de control")
  PATH = "./efficientnetl2__checkpoint_epoch_5_classic"
  torch.save({
              'epoch': 5,
  ...
  persist_tuple_prefix((train_loss, acc), "efficientnet_l2_reduced_")

  print("Almacenando punto de control")
  PATH = "./efficientnetl2__checkpoint_epoch_6_reduction"
  torch.save({
              'epoch': 6,
              'model_state_dict': net.state_dict(),
              'optimizer_state_dict': optimizer.state_dict(),
